...
const Features = () => {
  const features = [
    ...
    {
      title: "COMMENTI ITALIANI",
      description:
        "Aumentano il grado di rilevanza tra il tuo canale e il tuo target. Inoltre, non vengono rilevati dagli algoritmi.",
      iconUrl: icon6,
    },
    {
      title: "COMMENTI ALTA QUALITA’ Vs COMMENTI REALI",
      description:
        "I Commenti di alta qualità provengono da account del tutto simili a quelli “genuini”. Quelle reali, invece, provengono da account verificati.",
      iconUrl: icon5,
    },
    {
    ...
    },
    {
      ...
      description:
        "Comprare Commenti YouTube da GlowLikes è estremamente sicuro perché non richiediamo password o altri codici personali.",
      iconUrl: icon2,
    },
    {
      title: "PERCHE’ COMPRARE COMMENTI DI ALTA QUALITA’",
      description:
        "Con i Commenti YouTube di alta qualità nessuno noterà la tua strategia, nemmeno i tuoi reali follower.",
      icon: icon1,
    },
    {
      title: "CRESCITA ORGANICA A RISCHIO ZERO",
      description:
        "Comprare Commenti YouTube su GlowLikes ti permette di crescere in modo organico e di non subire alcuna penalizzazione dalla piattaforma.",
      iconUrl: growthIcon,
    },
  ];
