...
const reviews: Review[] = [
  {
    id: 1,
    stars: 5,
    text: "Oggi è difficile trovare un servizio decente, ma i commenti YouTube che ho comprato non mi stanno dando alcun problema. Me li hanno consegnati esattamente come li avevo scritti e li hanno consegnati in modo “non sgamo” 😎",
    name: "TonyZ",
    row: 'first'
  },
  {
  ...
  },
  {
    id: 3,
    stars: 4,
    text: "Dai, nn male! Su 20 commenti YouTube, 19 erano perfetti, nel senso che erano come li avevo scritti io, emoji incluse. Uno però era impreciso perché avevano incollato male un pezzo di frase. L’ho fatto presente allo Staff che ha risolto subito il problema.",
    name: "Enzo",
    row: 'first'
  },
  {
    id: 4,
    stars: 5,
    text: "Non sono molto pratica con queste cose e pensavo fosse più complicato. In ogni caso, per ordinare 30 commenti YouTube ci ho messo 3 minuti 💪 Pensavo ci volesse un po’ per la consegna, ma i primi sono arrivati già dopo un paio d’ore. Grandi!😘",
    name: "Sara",
    row: 'second'
  },
  {
    id: 5,
    stars: 5,
    text: "Ho già fatto 10 ordini, di conseguenza non mi interessano altre agenzie. Qui compro di tutto, non solo i commenti. Gli ordini arrivano sempre puntuale e data l’ottima qualità i prezzi sono super convenienti.",
    name: "Steve",
    row: 'second'
  }
];
