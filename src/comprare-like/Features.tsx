...
const Features = () => {
  const features = [
    ...
    },
    {
      title: "LIKE ITALIANI",
      description:
        "Aumenta il grado di rilevanza tra il tuo canale e il tuo target. Inoltre, non vengono rilevati dagli algoritmi.",
      iconUrl: icon6,
    },
    {
      title: "LIKE ALTA QUALITA’ Vs LIKE REALI",
      description:
        "I Like di alta qualità provengono da account del tutto simili a quelli “genuini”. Quelle reali, invece, provengono da account verificati.",
      iconUrl: icon5,
    },
    {
    ...
    {
      title: "PERCHE’ COMPRARE LIKE DI ALTA QUALITA’",
      description:
        "Con i Like YouTube di alta qualità nessuno noterà la tua strategia, nemmeno i tuoi reali follower.",
      icon: icon1,
    },
    {
      title: "CRESCITA ORGANICA A RISCHIO ZERO",
      description:
        "Comprare Like YouTube su GlowLikes ti permette di crescere in modo organico e di non subire alcuna penalizzazione dalla piattaforma.",
      iconUrl: growthIcon,
    },
  ];
