  ...
  return (
    <>
      ...
      <div className="relative pt-16 sm:pt-0  min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
        ...
        {/* Main content */}
        <div className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-32 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} transition-all duration-700 ease-out`}>
