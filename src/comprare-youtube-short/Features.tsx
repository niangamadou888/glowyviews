  ...
  const features = [
    {
      ...
      description:
        "Se hai effettuato un ordine con noi, riceverai visualizzazioni e like agli Shorts nel giro di un paio d’ore.",
      iconUrl: icon7,
    },
    {
      title: "VISUALIZZAZIONI E LIKE YOUTUBE SHORTS ITALIANI",
      description:
        "Aumentano il grado di rilevanza tra il tuo canale e il tuo target. Inoltre, non vengono rilevati dagli algoritmi.",
      iconUrl: icon6,
    },
    {
      title: "VISUALIZZAZIONI E LIKE YOUTUBE SHORTS ALTA QUALITA’ Vs VISUALIZZAZIONI E LIKE YOUTUBE SHORTS REALI",
      description:
        "Visualizzazioni e Like agli Shorts di alta qualità provengono da account del tutto simili a quelli “genuini”. Quelli reali, invece, provengono da account verificati.",
      iconUrl: icon5,
    },
    {
    ...
    },
    {
      ...
      description:
        "Comprare visualizzazioni e like YouTube Shorts da GlowLikes è estremamente sicuro perché non richiediamo password o altri codici personali.",
      iconUrl: icon2,
    },
    {
      title: "PERCHE’ COMPRARE VISUALIZZAZIONI E LIKE YOUTUBE SHORTS DI ALTA QUALITA’",
      description:
        "Comprare visualizzazioni e like YouTube Shorts su GlowLikes ti permette di crescere in modo organico e di non subire alcuna penalizzazione dalla piattaforma.",
      icon: icon1,
    },
    {
      title: "CRESCITA ORGANICA A RISCHIO ZERO",
      description:
        "Comprare Spettatori Diretta YouTube su GlowLikes ti permette di crescere in modo organico e di non subire alcuna penalizzazione dalla piattaforma.",
      iconUrl: growthIcon,
    },
  ];
