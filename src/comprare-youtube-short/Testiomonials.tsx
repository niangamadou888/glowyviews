...
const reviews: Review[] = [
  {
    id: 1,
    stars: 5,
    text: "Di solito compravo da agenzie estere per via dei prezzi più bassi. Però in caso di problemi era dura interfacciarsi con l’assistenza. Poi ho scoperto questa agenzia italiana e ho deciso di fare una prova con 10mila views che sono arrivate precise.",
    name: "Aldo",
    row: 'first'
  },
  {
    id: 2,
    stars: 5,
    text: "Concordo con le altre recensioni che leggo. È la terza volta compro 20mila like per gli Shorts ed è sempre andata benissimo. Provare altre agenzie? Anche no! Squadra che vince non si cambia! 😎 💪",
    name: "Erik",
    row: 'first'
  },
  {
    id: 3,
    stars: 5,
    text: "Salve a tutti, volevo fare i complimenti ai ragazzi di GlowLikes perché con le loro views e like non ho mai registrato nessun calo! Aspetto non scontato, visto che in passato ho avuto brutte esperienza. Continuate così! 🙏",
    name: "Nicola",
    row: 'first'
  },
  {
    id: 4,
    stars: 4,
    text: "Non per essere troppo pignolo ma se uno ordina 30mila like a uno short YouTube deve ricevere quel numero esatto. Nel mio caso ne mancavano 10, quindi nulla di grave. Però è una questione di serietà.",
    name: "Louis",
    row: 'second'
  },
  {
    id: 5,
    stars: 5,
    text: "Mi sono trovata benissimo perché ordinare visualizzazioni e like per gli Short YouTube è semplice e super veloce 🚀🚀 I prezzi più che accessibili e una vasta gamma di altri servizi niente male che sto già valutando.",
    name: "Giada",
    row: 'second'
  }
];
