...
const reviews: Review[] = [
  {
    id: 1,
    stars: 5,
    text: "Cosa ne penso? Servizio fantastico!!!😍😍 Proprio ieri ho ordinato 10mila condivisioni YouTube e le ho ricevute prima del previsto! 🚀🚀 Pensavo ci volesse qualche giorno… ma dopo 3-4 ore erano già arrivate quasi tutte! Sicuramente tornerò presto per un nuovo ordine 💪",
    name: "Jessica",
    row: 'first'
  },
  {
    id: 2,
    stars: 5,
    text: "Su 5 ordini non ho mai avuto alcun problema… nemmeno su quest’ultimo da 50mila condivisioni YouTube. Ammetto anche che qui ci sono i prezzi migliori del mercato italiano… ho provato tante agenzie ma o spendi troppo, oppure ti rifilano le condivisioni da bot.",
    name: "Marco",
    row: 'first'
  },
  {
    id: 3,
    stars: 5,
    text: "Senza dubbio uno dei miei migliori investimenti!! 💶💶 Ho trovato il rapporto qualità/prezzo che cercavo e sono davvero contento che l’ordine venga consegnato così rapidamente!! 👌 L’ho monitorato tramite la mia personale ed effettivamente sono stati puntualissimi! ⏱️⏱️",
    name: "Dave",
    row: 'first'
  },
  {
    id: 4,
    stars: 4,
    text: "Servizio molto buono… ma non perfetto. Praticamente è successo che 15mila condivisioni YouTube avevano un ammanco di circa 10-15… potevo lasciar perdere ma le ho pagate tutte. Quindi ho contattato lo Staff e mi hanno subito spedito quello che mi mancava…",
    name: "Riccardo",
    row: 'second'
  },
  {
    id: 5,
    stars: 5,
    text: "Pur essendo la mia prima volta vedo già che ottimi prodotti danno grandi risultati!!! Un paio di settimane fa ho comprato 60mila condivisioni YouTube e noto già che il mio canale sta andando alla grande!!📈📈 Non solo non ho avuto cali, ma sto pure crescendo bene!!👍👌",
    name: "Pier",
    row: 'second'
  }
];
