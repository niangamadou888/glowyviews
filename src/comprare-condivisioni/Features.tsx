  ...
  const features = [
    {
      ...
      description:
        "Se hai effettuato un ordine con noi, riceverai le condivisioni nel giro di un paio d’ore.",
      iconUrl: icon7,
    },
    {
      title: "CONDIVISIONI YOUTUBE ITALIANE",
      description:
        "Aumentano il grado di rilevanza tra il tuo canale e il tuo target. Inoltre, non vengono rilevati dagli algoritmi.",
      iconUrl: icon6,
    },
    {
      title: "CONDIVISIONI YOUTUBE ALTA QUALITA’ Vs CONDIVISIONI YOUTUBE REALI",
      description:
        "Le condivisioni di alta qualità provengono da account del tutto simili a quelli “genuini”. Quelle reali, invece, provengono da account verificati.",
      iconUrl: icon5,
    },
    {
    ...
    },
    {
      ...
      description:
        "Comprare condivisioni YouTube da GlowLikes è estremamente sicuro perché non richiediamo password o altri codici personali.",
      iconUrl: icon2,
    },
    {
      title: "PERCHE’ COMPRARE CONDIVISIONI YOUTUBE DI ALTA QUALITA’",
      description:
        "Con le condivisioni YouTube di alta qualità nessuno noterà la tua strategia, nemmeno i tuoi reali follower.",
      icon: icon1,
    },
    {
      title: "CRESCITA ORGANICA A RISCHIO ZERO",
      description:
        "Comprare condivisioni YouTube su GlowLikes ti permette di crescere in modo organico e di non subire alcuna penalizzazione dalla piattaforma.",
      iconUrl: growthIcon,
    },
  ];
