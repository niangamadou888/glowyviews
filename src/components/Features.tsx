  ...
  const features = [
    {
      ...
      description:
        "Le visualizzazioni di alta qualità provengono da account del tutto simili a quelli 'genuini'. Quelle reali, invece, provengono da account verificati.",
      iconUrl: icon7,
    },
    {
      title: "VISUALIZZAZIONI ITALIANE",
      description:
        "Aumenta il grado di rilevanza tra il tuo canale e il tuo target. Inoltre, non vengono rilevate dagli algoritmi.",
      iconUrl: icon6,
    },
    {
      title: "CONSEGNA RAPIDA",
      description:
        "Se hai effettuato un ordine con noi, riceverai le visualizzazioni comprate nel giro di un paio d'ore.",
      iconUrl: icon5,
    },
    {
      title: "SUPPORTO DEDICATO 24/7",
      description:
        "In caso di problemi, puoi sempre contare sul nostro Staff, sempre pronto ad aiutarti.",
      iconUrl: icon4,
    },
    {
    ...
    },
    {
      ...
      description:
        "Con le visualizzazioni YouTube di alta qualità nessuno noterà la tua strategia, nemmeno i tuoi reali follower.",
      iconUrl: icon1,
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <p className="mt-3">
          ...
          fruttare il tuo investimento sin da subito.
        </p>
      </div>
