...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className={`relative z-10 max-w-4xl mx-auto px-4 text-center transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
