                ...
                <div className="relative max-w-4xl mx-auto">
                    <div className="text-center mb-8">
                        ...
                        I - INFORMAZIONI RELATIVE ALLA PRIVACY POLICY DEL SITO
                            ...
                            <h4 className="text-xl font-bold text-white glow mt-12 mb-6 text-left ml-4">
                            ...
                            <ul>
                                <li>
                                Internet Explorer ed Edge: <a href="https://support.microsoft.com/it-it/help/17442/windows-internet-explorer-delete-manage-cookies" className='mystyle'>support microsoft</a>
                                </li>
                                <li>
                                Firefox: <a href="https://support.mozilla.org/it/kb/Attivare%20e%20disattivare%20i%20cookie" className='mystyle'>support mozilla</a>
                                </li>
                                <li>
                                Safari: <a href="https://support.apple.com/it-it/guide/safari/sfri11471/mac" className='mystyle'>support apple</a>
                                </li>
                                <li>
                                Chrome: <a href="https://support.google.com/accounts/answer/61416?hl=it" className='mystyle'>support google</a>
                                </li>
                            </ul>
                            </p>
                            <h3 className="text-2xl font-bold text-white glow mt-12 mb-6 text-left">
