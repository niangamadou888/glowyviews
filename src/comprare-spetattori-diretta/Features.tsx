...
const Features = () => {
  const features = [
    ...
    {
      title: "SPETTATORI DIRETTA ITALIANI",
      description:
        "Aumentano il grado di rilevanza tra il tuo canale e il tuo target. Inoltre, non vengono rilevati dagli algoritmi.",
      iconUrl: icon6,
    },
    {
      title: "SPETTATORI DIRETTA ALTA QUALITA’ Vs SPETTATORI DIRETTA REALI",
      description:
        "Gli Spettatori Diretta di alta qualità provengono da account del tutto simili a quelli “genuini”. Quelli reali, invece, provengono da account verificati.",
      iconUrl: icon5,
    },
    {
    ...
    },
    {
      ...
      description:
        "Comprare Spettatori Diretta YouTube da GlowLikes è estremamente sicuro perché non richiediamo password o altri codici personali.",
      iconUrl: icon2,
    },
    {
      title: "PERCHE’ COMPRARE SPETTATORI DIRETTA DI ALTA QUALITA’",
      description:
        "Con gli Spettatori Diretta YouTube di alta qualità nessuno noterà la tua strategia, nemmeno i tuoi reali follower.",
      icon: icon1,
    },
    {
